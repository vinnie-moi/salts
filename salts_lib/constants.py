...
MODES=__enum(MAIN='main', BROWSE='browse', TRENDING='trending', RECOMMEND='recommend', FRIENDS='friends', CAL='calendar', MY_CAL='my_calendar', MY_LISTS='lists', 
           ...
           DIRECT_DOWNLOAD='direct_download', POPULAR='popular')
...
HOST_Q[QUALITIES.MEDIUM]=['primeshare.tv', 'www.exashare.com', 'bestreams.net', 'www.flashx.tv', 'vidto.me', 'vodlocker.com']
HOST_Q[QUALITIES.HIGH]=['vidzi.tv', 'vidspot.net', 'vidbull.com', 'thevideo.me']
