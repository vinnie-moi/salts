    ...
    def get_sources(self, video):
        ...
        if source_url:
            ...
            for match in re.finditer(pattern, html, re.DOTALL):
                ...
                hoster = {'multi-part': False, 'host': host.lower(), 'class': self, 'url': stream_url, 'quality': self._blog_get_quality(video, quality_str.upper(), host), 'views': views, 'rating': None, 'direct': False}
