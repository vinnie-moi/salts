__all__ = ['scraper', 'local_scraper', 'pw_scraper', 'uflix_scraper', 'watchseries_scraper', 'movie25_scraper', 'merdb_scraper', '2movies_scraper', 'icefilms_scraper', 'afdah_scraper',
           ...
           'rlssource_scraper', 'pftv_scraper', 'cartoonhd_scraper', 'cmz_scraper', 'movienight_scraper', 'gvcenter_scraper', 'alluc_scraper', 'afdahorg_scraper', 'xmovies8_scraper',
           'tubemotion_scraper', 'yifystreaming_scraper', 'mintmovies_scraper', 'playbox_scraper']
