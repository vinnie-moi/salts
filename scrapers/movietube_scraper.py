...
class MovieTube_Scraper(scraper.Scraper):
    ...
    def search(self, video_type, title, year):
        ...
        html = self._http_get(search_url, data=data, headers=headers, cache_limit=0)
    ...
    def _http_get(self, url, data=None, headers=None, cache_limit=8):
        return super(MovieTube_Scraper, self)._cached_http_get(url, self.base_url, self.timeout, data=data, headers=headers, cache_limit=cache_limit)
