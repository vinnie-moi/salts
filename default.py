...
def auto_conf():
    ...
    if ret:
        ...
        sso = ['Local', 'DirectDownload.tv', 'VKBox', 'NoobRoom', 'yify-streaming', 'stream-tv.co', 'streamallthis.is', 'Dizimag', 'Dizilab', 'MovieFarsi', 'GVCenter', 'MegaboxHD', 'Shush.se', 'clickplay.to',
