...
def auto_conf():
    ...
    if ret:
        ...
        sso = ['Local', 'DirectDownload.tv', 'VKBox', 'NoobRoom', 'OneClickTVShows', 'yify-streaming', 'stream-tv.co', 'streamallthis.is', 'Dizimag', 'Dizilab', 'MovieFarsi', 'GVCenter',
               'MegaboxHD', 'Shush.se', 'clickplay.to', 'IceFilms', 'ororo.tv', 'afdah.org', 'xmovies8', 'Flixanity', 'hdmz', 'niter.tv', 'yify.tv', 'pubfilm', 'movietv.to', 'beinmovie', 'popcorntimefree',
               'tunemovie', 'MintMovies', 'MovieNight', 'cmz', 'viooz.ac', 'view47', 'MoviesHD', 'OnlineMovies', 'MoviesOnline7', 'wmo.ch', 'zumvo.com', 'mvsnap', 'alluc.com',
